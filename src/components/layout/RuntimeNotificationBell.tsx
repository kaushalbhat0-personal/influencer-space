    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 z-40 w-80 rounded-xl border border-white/10 bg-[var(--surface-overlay)] shadow-[var(--shadow-overlay)] overflow-hidden">
