...
/** themeConfig stores the image opacity as a percentage string (0..100). RCCF-08.1: allow 0 (invisible) to 100 (fully opaque) so background can disappear while content stays visible. */
export const IMAGE_OPACITY_MIN = 0;
...
/** Validates a themeConfig opacity percentage string (0..100). */
