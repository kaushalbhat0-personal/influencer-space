...
export const SECTION_REGISTRY: SectionDefinition[] = [
  ...
  { type: "bookings.default", label: "Bookings", description: "Book a session or appointment", allowedPages: ["/"], defaultConfiguration: {} },
  ...
  { type: "testimonials.default", label: "Testimonials", description: "Customer or fan testimonials", allowedPages: ["/", "/testimonials"], defaultConfiguration: { autoRotate: true } },
