...
/**
 * RCCF-LIVE-SMOKE-12 — TEMPORARY PRODUCTION RAZORPAY DIAGNOSTIC
...
export async function POST() {
  ...
  // Safe prefix/length — never expose full value. Prefix truncated to 8 chars.
  ...
  const config = {
    ...
    // In Production these should be empty — Vercel targets preview only
    testKeyIdProductionPresent: !!testKeyIdProd,
    testKeySecretProductionPresent: !!testSecretProd,
  };

  // Smoke mode check — server-side authority, never trusts client
