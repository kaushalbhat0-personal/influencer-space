...
export default async function BlueprintsPage() {
  ...
  return (
    <div className="p-6 max-w-6xl">
      <div className="mb-6">
        <h1 className="admin-gradient-text text-2xl font-bold font-display">Website Templates</h1>
        <p className="mt-1 text-sm text-gray-400">Choose a starting template for your website. Templates determine your page structure and sections.</p>
      </div>
