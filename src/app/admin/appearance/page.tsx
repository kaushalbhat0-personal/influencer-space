...
export default async function AppearancePage() {
  ...
  if (!tenantId) {
    return (
      <div>
        <h1 className="platform-display">Appearance</h1>
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="platform-display">Appearance & Theme</h1>
        <p className="platform-body mt-1.5">Customize colors, fonts, and layout. Changes appear in the live preview instantly.</p>
      </div>
