...
export default async function PublicPage({
  ...
  return (
    ...
    >
      {/* ─── Hero Banner ─── */}
      <HeroBanner videoUrl={hero.videoUrl || undefined} posterUrl={hero.posterUrl || undefined} desktopAlignment={hero.desktopAlignment} mobileAlignment={hero.mobileAlignment} />
