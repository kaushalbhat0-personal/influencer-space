...
export const COMMERCE_PLANS: CommercePlanConfig[] = [
  ...
  },
  {
    ...
    marketingDescription: "Unlimited products and gallery, premium themes, a full visual builder and AI credits (coming soon).",
  ...
  },
  {
    ...
    marketingDescription: "Everything in Growth, plus your own custom domain, platform-managed payment webhooks, live social sync, team members and advanced analytics.",
